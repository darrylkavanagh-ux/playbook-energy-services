...
export default function UtilityAudit() {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="mailto:audit@foxliteforensics.ie" className="neo-button text-center text-xl">
              Request Audit
            </a>
            <Link href="/">
        ...
        <div className="lg:col-span-5 relative">
          <div className="aspect-square bg-black border-4 border-black relative overflow-hidden neo-shadow">
             <div className="w-full h-full bg-[#FFD700] flex items-center justify-center">
                <span className="text-9xl font-black opacity-20 rotate-45">AUDIT</span>
             </div>
