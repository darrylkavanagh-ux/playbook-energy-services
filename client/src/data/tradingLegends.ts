...
export const TECH_ERAS: TechEra[] = [
  ...
  },
  {
    ...
    period: '2015–present',
    years: [2015, 2026],
    description: 'Deep learning (2012), transformer architectures (2017), and large-scale language models (2020) transformed quantitative finance. Natural language processing now parses central bank speeches in milliseconds. Reinforcement learning agents trade in live markets. Alternative data — satellite imagery of car parks, credit card transaction data, social media sentiment — now generates significant alpha. The Orb AI Multi-Asset Trading Engine (2026) sits in this era, combining precision technical analysis with human-in-the-loop verification and the responsible AI trading frontier.',
